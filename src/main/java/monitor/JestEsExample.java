...
/**
 * @Author: xiliang
 * @Date: 2018/9/20 19:31
 **/

public class JestEsExample {

  private  class JestEsConfig {
        ...
        public JestEsConfig(String esUrl){
    ...
    static protected final Log log = LogFactory.getLog(JestEsExample.class.getName());

    JestEsConfig esConfig = new JestEsConfig(ConfigHelper.Elasticseach_Host);
